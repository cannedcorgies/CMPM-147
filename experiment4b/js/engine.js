...
function setup() {
  ...
  createP("Minesweeper. Arrow keys scroll. Clicking selects tile. Enter new world key to start over.").parent("container");
  createP("More intense the tile color, the more mines that are surrounding it.").parent("container");
...
function draw() {
  ...
  if (!gameOver) {describeMouseTile(world_pos, [camera_offset.x, camera_offset.y]);}
